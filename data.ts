...
export const faqs = [
  ...
  { q: "What is the internship duration?", a: "The core program runs for 3 months, with course-specific tracks ranging from 6 to 12 weeks depending on the domain." },
  ...
  { q: "Is there a registration fee?", a: "Yes, a one-time registration fee of ₹150 to confirm your seat. Payment details are on the registration page." },
