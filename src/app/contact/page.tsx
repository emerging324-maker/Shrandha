        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Reveal delay={0.2}>
            <div className="flex gap-3 pt-2">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass flex items-center justify-center hover:text-cyan focus-ring" aria-label="LinkedIn"><Linkedin className="w-5 h-5" /></a>
            </div>
          </Reveal>
        </div>
