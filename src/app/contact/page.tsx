        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Reveal delay={0.05}>
            <a href="tel:+919000000000">
              <Card className="flex items-center gap-4 hover:border-cyan/40">
                ...
                <div><p className="font-medium">Call Us</p><p className="text-sm text-muted">+91 90000 00000</p></div>
              </Card>
            </a>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.2}>
            <div className="flex gap-3 pt-2">
              ...
              <a href="https://www.linkedin.com/in/shrandha-labs-5a24ba428?utm_source=share_via&utm_content=profile&utm_medium=member_ios" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass flex items-center justify-center hover:text-cyan focus-ring" aria-label="LinkedIn"><Linkedin className="w-5 h-5" /></a>
            </div>
          </Reveal>
        </div>
