 ...
 *
 * Only Name, Domain, and Duration are supplied by the admin. Certificate
 * ID and Issue Date are generated automatically upstream. The MSME badge
 * shown here is generic (no registration number) — matching the redacted
 * sample certificate used elsewhere on the site.
 */
export function CertificateTemplate({
  ...
  return (
    ...
    >
      ...
      {/* Corner accents */}
      <div style={{ position: "absolute", top: 0, left: 0, width: 220, height: 220, borderTop: "10px solid #07070A", borderLeft: "10px solid #07070A" }} />
      ...
      <div style={{ position: "absolute", top: 56, left: 72, display: "flex", alignItems: "center", gap: 16 }}>
        <img src="/images/logo-mark.png" alt="" width={64} height={64} crossOrigin="anonymous" />
        <div>
          <div style={{ fontSize: 28, fontWeight: 700, color: "#07070A" }}>
            Shrandha <span style={{ color: "#F5A623" }}>Labs</span>
          </div>
          <div style={{ fontSize: 12, letterSpacing: 2, color: "#9A9AA6", marginTop: 2 }}>LEARN. BUILD. ACHIEVE.</div>
        </div>
      </div>

      {/* Generic MSME badge, top-right — no registration number */}
      <div style={{ position: "absolute", top: 56, right: 72, textAlign: "right", maxWidth: 260 }}>
        <div style={{ fontSize: 22, fontWeight: 800, letterSpacing: 1, color: "#0f1730" }}>MSME</div>
        <div style={{ fontSize: 12, color: "#4b4b55", marginTop: 2 }}>Ministry of MSME, Govt. of India</div>
      </div>

      {/* Title */}
      <div style={{ textAlign: "center", marginTop: 62 }}>
        <div className={playfair.className} style={{ fontSize: 60, letterSpacing: 6, color: "#0f1730" }}>
          CERTIFICATE
        </div>
        <div style={{ marginTop: 8, fontSize: 19, letterSpacing: 6, color: "#4b4b55" }}>
      ...
      <div style={{ textAlign: "center", marginTop: 50 }}>
        ...
        <div style={{ margin: "16px auto 0", width: 620, height: 1, background: "#d9b76c" }} />

        <div style={{ marginTop: 28, fontSize: 19, color: "#3a3a42" }}>has successfully completed the</div>
        ...
        <div style={{ marginTop: 22, fontSize: 16, color: "#4b4b55", maxWidth: 900, marginLeft: "auto", marginRight: "auto", lineHeight: 1.7 }}>
      ...
      <div style={{ position: "absolute", bottom: 64, left: 72, display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ position: "absolute", bottom: 50, left: "50%", transform: "translateX(-50%)", textAlign: "center" }}>
        ...
        >
          <img src="/images/logo-mark.png" alt="" width={56} height={56} crossOrigin="anonymous" style={{ filter: "brightness(0) invert(1)" }} />
        </div>
      </div>

      <div style={{ position: "absolute", bottom: 64, right: 100, textAlign: "center" }}>
        <div className={greatVibes.className} style={{ fontSize: 32, color: "#0f1730" }}>Shrandha Labs</div>
